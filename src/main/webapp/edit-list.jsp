...
<body>
	<form action="editListDetailsServlet" method="post">
		...
		Raffle date: <input type="text" name="month" placeholder="mm" size="4" value="${month}">
		<input type="text" name="day" placeholder="dd" size="4" value="${date}">, <input type="text" name="year" placeholder="yyyy" size="4" value="${year}">
		Host Name: <input type="text" name="shopperName" value="${listToEdit.shopper.shopperName}"><br />
	...
	<a href="index.html">Go add new entries instead.</a>
</body>
</html>